...
@router.get("/{comment_id:int}", response_model=schema.Comment)
...
@router.get("/all", response_model=List[schema.Comment])
...
# 댓글 생성 API
@router.post("", response_model=schema.CommentCreate)
...
# 댓글 수정 API
@router.patch("/{comment_id:int}", response_model=schema.CommentUpdate)
...
# 댓글 삭제 API
@router.delete("/{comment_id:int}", response_model=schema.CommentDelete)
